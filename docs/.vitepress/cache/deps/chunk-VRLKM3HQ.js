...
// node_modules/.pnpm/vue-arco-ui@0.1.52_@arco-design+web-vue@2.53.3/node_modules/vue-arco-ui/dist/index-c35b6893.js
function tt(e) {
...
var it = function(e, t) {
  ...
  for (var $, b, f = document.scrollingElement || document.documentElement, E = [], m = e; tt(m) && d(m); ) {
    ...
    m != null && m === document.body && Le2(m) && !Le2(document.documentElement) || m != null && Le2(m, c) && E.push(m);
  }
  for (var x = i.visualViewport ? i.visualViewport.width : innerWidth, p = i.visualViewport ? i.visualViewport.height : innerHeight, v = window.scrollX || pageXOffset, k = window.scrollY || pageYOffset, V = e.getBoundingClientRect(), q = V.height, M = V.width, L = V.top, P = V.right, s = V.bottom, u = V.left, y = o === "start" || o === "nearest" ? L : o === "end" ? s : L + q / 2, g = a === "center" ? u + M / 2 : a === "end" ? P : u, C = [], S = 0; S < E.length; S++) {
    ...
    if (r === "if-needed" && L >= 0 && u >= 0 && s <= p && P <= x && L >= ce && s <= j && u >= O && P <= n)
      return C;
    var _ = getComputedStyle(w), Q = parseInt(_.borderLeftWidth, 10), H = parseInt(_.borderTopWidth, 10), F = parseInt(_.borderRightWidth, 10), B = parseInt(_.borderBottomWidth, 10), R = 0, A = 0, z = "offsetWidth" in w ? w.offsetWidth - w.clientWidth - Q - F : 0, fe = "offsetHeight" in w ? w.offsetHeight - w.clientHeight - H - B : 0, De2 = "offsetWidth" in w ? w.offsetWidth === 0 ? 0 : ue / w.offsetWidth : 0, Ke = "offsetHeight" in w ? w.offsetHeight === 0 ? 0 : se / w.offsetHeight : 0;
    if (f === w)
      R = o === "start" ? y : o === "end" ? y - p : o === "nearest" ? he2(k, k + p, p, H, B, k + y, k + y + q, q) : y - p / 2, A = a === "start" ? g : a === "center" ? g - x / 2 : a === "end" ? g - x : he2(v, v + x, x, Q, F, v + g, v + g + M, M), R = Math.max(0, R + k), A = Math.max(0, A + v);
    else {
      R = o === "start" ? y - ce - H : o === "end" ? y - j + B + fe : o === "nearest" ? he2(ce, j, se, H, B + fe, y, y + q, q) : y - (ce + se / 2) + fe / 2, A = a === "start" ? g - O - Q : a === "center" ? g - (O + ue / 2) + z / 2 : a === "end" ? g - n + F + z : he2(O, n, ue, Q, F + z, g, g + M, M);
      var Ye = w.scrollLeft, Ue2 = w.scrollTop;
      y += Ue2 - (R = Math.max(0, Math.min(Ue2 + R / Ke, w.scrollHeight - se / Ke + fe))), g += Ye - (A = Math.max(0, Math.min(Ye + A / De2, w.scrollWidth - ue / De2 + z)));
    }
...
var at = (e, t, i) => t in e ? Nt(e, t, { enumerable: true, configurable: true, writable: true, value: i }) : e[t] = i;
...
var Xt = defineComponent({ name: "Form", props: { model: { type: Object, required: true }, layout: { type: String, default: "horizontal" }, size: { type: String }, labelColProps: { type: Object, default: () => ({ span: 5, offset: 0 }) }, wrapperColProps: { type: Object, default: () => ({ span: 19, offset: 0 }) }, labelColStyle: Object, wrapperColStyle: Object, labelAlign: { type: String, default: "right" }, disabled: { type: Boolean, default: void 0 }, rules: { type: Object }, autoLabelWidth: { type: Boolean, default: false }, id: { type: String }, scrollToFirstError: { type: Boolean, default: false } }, emits: { submit: (e, t) => true, submitSuccess: (e, t) => true, submitFailed: (e, t) => true }, setup(e, { emit: t }) {
  const i = pe("form"), r = ref(), { id: o, model: a, layout: l, disabled: c, labelAlign: d, labelColProps: $, wrapperColProps: b, labelColStyle: f, wrapperColStyle: E, size: m, rules: x } = toRefs(e), { mergedSize: p } = Ul(m), v = computed(() => e.layout === "horizontal" && e.autoLabelWidth), k = [], V = reactive({}), q = computed(() => Math.max(...Object.values(V))), M = (s, u) => {
    const y = (r.value || document.body).querySelector(`#${vt(e.id, s)}`);
    y && Yt(y, ((g, C) => {
      for (var S in C || (C = {}))
        Zt.call(C, S) && dt(g, S, C[S]);
      if (ct)
        for (var S of ct(C))
  ...
  return provide(J4, reactive({ id: o, layout: l, disabled: c, labelAlign: d, labelColProps: $, wrapperColProps: b, labelColStyle: f, wrapperColStyle: E, model: a, size: p, rules: x, fields: k, touchedFields: [], addField: (s) => {
    s && s.field && k.push(s);
  }, removeField: (s) => {
...
var Me = Le(Xt, [["render", function(e, t, i, r, o, a) {
...
var He = function(e, t) {
  ...
  return Object.keys(t || {}).forEach(function(r) {
    ...
    i[r] = Z(o) ? Object.assign(Object.assign({}, o), a) : a || o;
  }), i;
};
var X = "#{field} is not a #{type} type";
var Gt = { required: "#{field} is required", type: { ip: X, email: X, url: X, string: X, number: X, array: X, object: X, boolean: X }, number: { min: "`#{value}` is not greater than `#{min}`", max: "`#{value}` is not less than `#{max}`", equal: "`#{value}` is not equal to `#{equal}`", range: "`#{value}` is not in range `#{min} ~ #{max}`", positive: "`#{value}` is not a positive number", negative: "`#{value}` is not a negative number" }, string: { maxLength: "#{field} cannot be longer than #{maxLength} characters", minLength: "#{field} must be at least #{minLength} characters", length: "#{field} must be exactly #{length} characters", match: "`#{value}` does not match pattern #{pattern}", uppercase: "`#{value}` must be all uppercase", lowercase: "`#{value}` must be all lowercased" }, array: { length: "#{field} must be exactly #{length} in length", minLength: "#{field} cannot be less than #{minLength} in length", maxLength: "#{field} cannot be greater than #{maxLength} in length", includes: "#{field} is not includes #{includes}", deepEqual: "#{field} is not deep equal with #{deepEqual}", empty: "#{field} is not an empty array" }, object: { deepEqual: "#{field} is not deep equal to expected value", hasKeys: "#{field} does not contain required fields", empty: "#{field} is not an empty object" }, boolean: { true: "Expect true but got `#{value}`", false: "Expect false but got `#{value}`" } };
var I = function(e, t) {
  var i = this;
  ...
  }, Z(t) && We(e) && t.trim ? this.obj = e.trim() : Z(t) && t.ignoreEmptyString && e === "" ? this.obj = void 0 : this.obj = e, this.message = t.message, this.type = t.type, this.error = null, this.field = t.field || t.type, this.validateMessages = He(Gt, t.validateMessages);
};
...
ve.not.get = function() {
  ...
  if (te(this.obj) || mt(this.obj)) {
    ...
    this.error = { value: this.obj, type: this.type, requiredError: true, message: this.message || (Z(e) ? e : (this._not ? "[NOT MODE]:" : "") + e) };
  }
  return this;
}, ve.end.get = function() {
  return this.error;
}, I.prototype.addError = function(e) {
  !this.error && e && (this.error = { value: this.obj, type: this.type, message: this.message || (Z(e) ? e : (this._not ? "[NOT MODE]:" : "") + e) });
...
var rr = function(e) {
  function t(r, o) {
    e.call(this, r, Object.assign(Object.assign({}, o), { type: "object" })), this.validate(!o || !o.strict || Z(this.obj), this.getValidateMsg("type.object"));
  }
  e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t;
  var i = { empty: { configurable: true } };
  return t.prototype.deepEqual = function(r) {
    ...
    return this.validate(Z(r = this.obj) && Object.keys(r).length === 0, this.getValidateMsg("object.empty"));
    var r;
  }, Object.defineProperties(t.prototype, i), t;
}(I);
var ir = function(e) {
...
var ur = Le(defineComponent({ name: "Row", props: { gutter: { type: [Number, Object, Array], default: 0 }, justify: { type: String, default: "start" }, align: { type: String, default: "start" }, div: { type: Boolean }, wrap: { type: Boolean, default: true } }, setup(e) {
  const { gutter: t, align: i, justify: r, div: o, wrap: a } = toRefs(e), l = pe("row"), c = computed(() => ({ [`${l}`]: !o.value, [`${l}-nowrap`]: !a.value, [`${l}-align-${i.value}`]: i.value, [`${l}-justify-${r.value}`]: r.value })), d = computed(() => Array.isArray(t.value) ? t.value[0] : t.value), $ = computed(() => Array.isArray(t.value) ? t.value[1] : 0), b = _e(d, 0), f = _e($, 0), E = computed(() => {
    const x = {};
...
var fr = Le(defineComponent({ name: "Col", props: { span: { type: Number, default: 24 }, offset: { type: Number }, order: { type: Number }, xs: { type: [Number, Object] }, sm: { type: [Number, Object] }, md: { type: [Number, Object] }, lg: { type: [Number, Object] }, xl: { type: [Number, Object] }, xxl: { type: [Number, Object] }, flex: { type: [Number, String] } }, setup(e) {
...
var Ve = Le(hr, [["render", function(e, t, i, r, o, a) {
...
var jr = Le(vr, [["render", function(e, t, i, r, o, a) {
...
var xr = Le(defineComponent({ name: "FormItemMessage", props: { error: { type: Array, default: () => [] }, help: String }, setup: () => ({ prefixCls: pe("form-item-message") }) }), [["render", function(e, t, i, r, o, a) {
...
var qe = Le(defineComponent({ name: "FormItem", components: { ArcoRow: ur, ArcoCol: fr, FormItemLabel: jr, FormItemMessage: xr }, props: { field: { type: String, default: "" }, label: String, tooltip: { type: String }, showColon: { type: Boolean, default: false }, noStyle: { type: Boolean, default: false }, disabled: { type: Boolean, default: void 0 }, help: String, extra: String, required: { type: Boolean, default: false }, asteriskPosition: { type: String, default: "start" }, rules: { type: [Object, Array] }, validateStatus: { type: String }, validateTrigger: { type: [String, Array], default: "change" }, labelColProps: Object, wrapperColProps: Object, hideLabel: { type: Boolean, default: false }, hideAsterisk: { type: Boolean, default: false }, labelColStyle: Object, wrapperColStyle: Object, rowProps: Object, rowClass: [String, Array, Object], contentClass: [String, Array, Object], contentFlex: { type: Boolean, default: true }, mergeProps: { type: [Boolean, Function], default: true }, labelColFlex: { type: [Number, String] }, feedback: { type: Boolean, default: false }, labelComponent: { type: String, default: "label" }, labelAttrs: Object }, setup(e) {
  const t = pe("form-item"), { field: i } = toRefs(e), r = inject(J4, {}), { autoLabelWidth: o, layout: a } = toRefs(r), { i18nMessage: l } = oa(), c = computed(() => {
    ...
    var n, j, O;
    const _ = [].concat((O = (j = e.rules) != null ? j : (n = r == null ? void 0 : r.rules) == null ? void 0 : n[e.field]) != null ? O : []), Q = _.some((H) => H.required);
    return e.required && !Q ? [{ required: true }].concat(_) : _;
  ...
  return { prefixCls: t, cls: se, isRequired: P, isError: M, finalMessage: p, mergedLabelCol: c, mergedWrapperCol: d, labelColCls: ue, autoLabelWidth: o, layout: a, mergedLabelStyle: $, wrapperColCls: ce, mergedWrapperStyle: b };
} }), [["render", function(e, t, i, r, o, a) {
  var l;
...
//# sourceMappingURL=chunk-VRLKM3HQ.js.map
