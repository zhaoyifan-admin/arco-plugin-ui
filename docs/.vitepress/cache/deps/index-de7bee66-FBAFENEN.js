...
// node_modules/.pnpm/vue-arco-ui@0.1.48_@arco-design+web-vue@2.53.3/node_modules/vue-arco-ui/dist/index-de7bee66.js
var _e = defineComponent({ name: "Divider", props: { direction: { type: String, default: "horizontal" }, orientation: { type: String, default: "center" }, type: { type: String }, size: { type: Number }, margin: { type: [Number, String] } }, setup(e, { slots: t }) {
  const a = pe("divider"), l = computed(() => e.direction === "horizontal"), r = computed(() => {
    const c = {};
    if (e.size && (c[l.value ? "border-bottom-width" : "border-left-width"] = me(e.size) ? `${e.size}px` : e.size), e.type && (c[l.value ? "border-bottom-style" : "border-left-style"] = e.type), !xl(e.margin)) {
      const n = me(e.margin) ? `${e.margin}px` : e.margin;
...
var pa = je(defineComponent({ name: "TabsTab", components: { IconHover: Nl, IconClose: Ln }, props: { tab: { type: Object, required: true }, active: Boolean, editable: Boolean }, emits: ["click", "delete"], setup(e, { emit: t }) {
...
var vt = defineComponent({ name: "TabsButton", props: { type: { type: String, default: "next" }, direction: { type: String, default: "horizontal" }, disabled: { type: Boolean, default: false }, onClick: { type: Function } }, emits: ["click"], setup(e, { emit: t }) {
  ...
  return () => {
    let c;
    return createVNode("div", { class: r.value, onClick: l }, [createVNode(Nl, { disabled: e.disabled }, (n = c = e.direction === "horizontal" ? e.type === "next" ? createVNode(w2, null, null) : createVNode(W2, null, null) : e.type === "next" ? createVNode(_s, null, null) : createVNode(Y2, null, null), typeof n == "function" || Object.prototype.toString.call(n) === "[object Object]" && !isVNode(n) ? c : { default: () => [c] }))]);
    var n;
  };
} });
...
var fa = defineComponent({ name: "TabsNav", props: { tabs: { type: Array, required: true }, direction: { type: String, required: true }, type: { type: String, required: true }, activeKey: { type: [String, Number] }, activeIndex: { type: Number, required: true }, position: { type: String, required: true }, size: { type: String, required: true }, showAddButton: { type: Boolean, default: false }, editable: { type: Boolean, default: false }, animation: { type: Boolean, required: true }, headerPadding: { type: Boolean, default: true } }, emits: ["click", "add", "delete"], setup(e, { emit: t, slots: a }) {
  const { tabs: l, activeKey: r, activeIndex: c, direction: n } = toRefs(e), i = pe("tabs-nav"), o = ref(), u = ref(), p = ref({}), C = computed(() => {
  ...
  }), b = ref(), S = computed(() => e.editable && ["line", "card", "card-gutter"].includes(e.type)), k = ref(false), N = ref(0), w = ref(0), B = ref([]), K = ref(0), A = () => {
    var E, I, s;
    k.value = j(), k.value ? (N.value = (s = n.value === "vertical" ? (E = o.value) == null ? void 0 : E.offsetHeight : (I = o.value) == null ? void 0 : I.offsetWidth) != null ? s : 0, w.value = u.value && o.value ? n.value === "vertical" ? u.value.offsetHeight - o.value.offsetHeight : u.value.offsetWidth - o.value.offsetWidth : 0, B.value = l.value.map((h2) => {
    ...
    var I;
    return ((I = B.value[E - 1]) != null ? I : 0) >= K.value && B.value[E] <= K.value + N.value;
  }, U = (E, I) => {
    t("click", E, I);
  }, _ = (E, I) => {
    t("delete", E, I);
    ...
    var I;
    K.value = (I = ((s) => o.value ? s === "previous" ? K.value - N.value : K.value + N.value : 0)(E), !o.value || !u.value || I < 0 ? 0 : I > w.value ? w.value : I);
  }, m2 = () => {
    ...
    nextTick(() => {
      ...
      if (k.value)
        if (E >= I) {
          ...
          H(h2) || (K.value = B.value[h2] - N.value);
        } else {
          const h2 = E > 0 ? E - 1 : E;
  ...
  const P = () => S.value && e.showAddButton ? createVNode("div", { class: `${i}-add-btn`, onClick: (E) => t("add", E) }, [createVNode(Nl, null, { default: () => [createVNode(ir, null, null)] })]) : null, de = computed(() => [i, `${i}-${e.direction}`, `${i}-${e.position}`, `${i}-size-${e.size}`, `${i}-type-${e.type}`]), Se = computed(() => [`${i}-tab-list`, { [`${i}-tab-list-no-padding`]: !e.headerPadding && ["line", "text"].includes(e.type) && e.direction === "horizontal" }]), ke = computed(() => (({ direction: E, type: I, offset: s }) => E === "vertical" ? { transform: `translateY(${-s}px)` } : { transform: `translateX(${-s}px)` })({ direction: e.direction, type: e.type, offset: K.value })), ae = computed(() => [`${i}-tab`, { [`${i}-tab-scroll`]: k.value }]);
  return () => {
    var E;
    return createVNode("div", { class: de.value }, [k.value && createVNode(vt, { type: "previous", direction: e.direction, disabled: K.value <= 0, onClick: G }, null), createVNode(To, { onResize: () => A() }, { default: () => [createVNode("div", { class: ae.value, ref: o }, [createVNode(To, { onResize: m2 }, { default: () => [createVNode("div", { ref: u, class: Se.value, style: ke.value }, [e.tabs.map((I, s) => createVNode(pa, { key: I.key, ref: (h2) => {
...
var Fe2 = defineComponent({ name: "Tabs", props: { activeKey: { type: [String, Number], default: void 0 }, defaultActiveKey: { type: [String, Number], default: void 0 }, position: { type: String, default: "top" }, size: { type: String }, type: { type: String, default: "line" }, direction: { type: String, default: "horizontal" }, editable: { type: Boolean, default: false }, showAddButton: { type: Boolean, default: false }, destroyOnHide: { type: Boolean, default: false }, lazyLoad: { type: Boolean, default: false }, justify: { type: Boolean, default: false }, animation: { type: Boolean, default: false }, headerPadding: { type: Boolean, default: true }, autoSwitch: { type: Boolean, default: false }, hideContent: { type: Boolean, default: false }, trigger: { type: String, default: "click" } }, emits: { "update:activeKey": (e) => true, change: (e) => true, tabClick: (e, t) => true, add: (e) => true, delete: (e, t) => true }, setup(e, { emit: t, slots: a }) {
  ...
  const A = (m2) => {
    ...
    t("add", m2), e.autoSwitch && nextTick(() => {
      const P = N.value[N.value.length - 1];
      A(P);
    });
  }, U = (m2, P) => {
    t("delete", m2, P);
...
var Ee = je(defineComponent({ name: "TabPane", props: { title: String, disabled: { type: Boolean, default: false }, closable: { type: Boolean, default: true }, destroyOnHide: { type: Boolean, default: false } }, setup(e, { slots: t }) {
  ...
  return n != null && n.uid && ((a = o.addItem) == null || a.call(o, n.uid, S)), onBeforeUnmount(() => {
    ...
    S.slots = ((k, N) => {
      for (var w in N || (N = {}))
        ga.call(N, w) && yt(k, w, N[w]);
      if (pt)
        for (var w of pt(N))
          ka.call(N, w) && yt(k, w, N[w]);
      return k;
    })({}, t);
...
var ba = Object.assign(Fe2, { TabPane: Ee, install: (e, t) => {
  $l(e, t);
  const a = Sl(t);
  e.component(a + Fe2.name, Fe2), e.component(a + Ee.name, Ee);
} });
...
var Ca = defineComponent({ name: "TreeNodeSwitcher", components: { IconLoading: ht, RenderFunction: m }, props: { prefixCls: String, loading: Boolean, showLine: Boolean, treeNodeData: { type: Object }, icons: { type: Object }, nodeStatus: { type: Object } }, emits: ["click"], setup(e, { slots: t, emit: a }) {
  const { icons: l, nodeStatus: r, treeNodeData: c } = toRefs(e), n = Be(), i = Sp(t, "switcher-icon"), o = Sp(t, "loading-icon");
  ...
  if (o)
    return (e = c()) != null ? e : h(ht);
  let b = null, S = false;
  if (C)
    u && (b = (a = r()) != null ? a : h(Na));
  else {
    const N = u ? h("span", { class: `${l}-${p ? "minus" : "plus"}-icon` }) : h(jv);
    b = (t = r()) != null ? t : N, S = !u;
  }
  if (!b)
    return null;
  const k = h("span", { class: `${l}-switcher-icon`, onClick: n }, b);
  return S ? h(Nl, { class: `${l}-icon-hover` }, () => k) : k;
} });
...
var bt = (e, t, a) => t in e ? Ka(e, t, { enumerable: true, configurable: true, writable: true, value: a }) : e[t] = a;
var Ve = (e, t) => {
  for (var a in t || (t = {}))
    Da.call(t, a) && bt(e, a, t[a]);
  if (kt)
    for (var a of kt(t))
      Ea.call(t, a) && bt(e, a, t[a]);
  return e;
};
var mt = (e, t) => wa(e, $a(t));
var Bt = (() => {
...
function xt({ subEnable: e, superEnable: t, isLeaf: a, treeNodeData: l, level: r }) {
  return xl(e) ? Je(t) ? t(l, { isLeaf: a, level: r }) : t != null && t : e;
}
function Ta(e) {
  var t, a;
  const { treeNodeData: l, parentNode: r, isTail: c = true, treeProps: n } = e, { fieldNames: i } = n || {}, o = function(k, N) {
    const w = Ve({}, k);
    return N && Object.keys(N).forEach((B) => {
      const K = N[B];
      K !== B && (w[B] = k[K], delete w[K]);
    }), w;
  }(l, i), u = n.loadMore ? !!o.isLeaf : !((t = o.children) != null && t.length), p = r ? r.level + 1 : 0, C = mt(Ve({}, ta(o, ["children"])), { key: (a = o.key) != null ? a : Bt(), selectable: xt({ subEnable: o.selectable, superEnable: n == null ? void 0 : n.selectable, isLeaf: u, level: p, treeNodeData: l }), disabled: !!o.disabled, disableCheckbox: !!o.disableCheckbox, checkable: xt({ subEnable: o.checkable, superEnable: n == null ? void 0 : n.checkable, isLeaf: u, level: p, treeNodeData: l }), isLeaf: u, isTail: c, blockNode: !!(n != null && n.blockNode), showLine: !!(n != null && n.showLine), level: p, lineless: r ? [...r.lineless, r.isTail] : [], draggable: (b = o.draggable, S = n == null ? void 0 : n.draggable, !!(xl(b) ? S : b)) });
  var b, S;
...
var La = defineComponent({ name: "BaseTreeNode", components: { NodeSwitcher: Ca, Checkbox: wt, RenderFunction: m, IconDragDotVertical: hv }, props: { key: { type: [String, Number] }, title: { type: String }, selectable: { type: Boolean }, disabled: { type: Boolean }, disableCheckbox: { type: Boolean }, checkable: { type: Boolean }, draggable: { type: Boolean }, isLeaf: { type: Boolean }, icon: { type: Function }, switcherIcon: { type: Function }, loadingIcon: { type: Function }, dragIcon: { type: Function }, isTail: { type: Boolean }, blockNode: { type: Boolean }, showLine: { type: Boolean }, level: { type: Number, default: 0 }, lineless: { type: Array, default: () => [] } }, setup(e) {
  ...
  }), N = ref(), { isDragOver: w, isDragging: B, isAllowDrop: K, dropPosition: A, setDragStatus: j } = function(s) {
    const { key: h2, refTitle: z } = toRefs(s), M = Be(), ye = ref(false), Ne = ref(false), be = ref(false), T = ref(0), Z = qr((se) => {
      if (!z.value)
        return;
      const J = z.value.getBoundingClientRect(), fe = window.pageYOffset + J.top, { pageY: Ce2 } = se, le = J.height / 4, ie = Ce2 - fe;
  ...
  }(reactive({ key: t, refTitle: N })), H = computed(() => [`${a}-title`, { [`${a}-title-draggable`]: S.value, [`${a}-title-gap-top`]: w.value && K.value && A.value < 0, [`${a}-title-gap-bottom`]: w.value && K.value && A.value > 0, [`${a}-title-highlight`]: !B.value && w.value && K.value && A.value === 0, [`${a}-title-dragging`]: B.value, [`${a}-title-block`]: r.value.blockNode }]), U = computed(() => {
    var s, h2;
  ...
  }), de = computed(() => l.dragIcon), Se = computed(() => l.nodeIcon);
  function ke(s) {
    var h2, z;
    o.value || (!((h2 = n.value) != null && h2.length) && Je(l.onLoadMore) ? l.onLoadMore(t.value) : (z = l == null ? void 0 : l.onExpand) == null || z.call(l, !m2.value, t.value, s));
  }
  ...
  return { nodekey: t, refTitle: N, prefixCls: a, classNames: k, titleClassNames: H, indeterminate: _, checked: U, expanded: m2, selected: G, treeTitle: E, treeNodeData: c, loading: P, treeDragIcon: de, treeNodeIcon: Se, extra: I, nodeStatus: ae, onCheckboxChange(s, h2) {
    var z;
...
function Fa(e) {
  const { defaultCheckedKeys: t, checkedKeys: a, key2TreeNode: l, checkStrictly: r, halfCheckedKeys: c, onlyCheckLeaf: n } = toRefs(e), i = ref(false), o = ref([]), u = ref([]), p = ref(), C = ref(), b = (k) => function(N) {
    const { initCheckedKeys: w, key2TreeNode: B, checkStrictly: K, onlyCheckLeaf: A } = N, j = /* @__PURE__ */ new Set(), H = /* @__PURE__ */ new Set(), U = /* @__PURE__ */ new Set();
  ...
  }), { checkedKeys: computed(() => p.value || o.value), indeterminateKeys: computed(() => r.value && c.value ? c.value : C.value || u.value), setCheckedState: (k, N, w = false) => (w ? S(k) : (o.value = k, u.value = N), [o.value, u.value]) };
}
function Ra(e) {
  const { treeData: t, fieldNames: a, selectable: l, showLine: r, blockNode: c, checkable: n, loadMore: i, draggable: o } = toRefs(e), u = ref([]);
  watchEffect(() => {
    var b, S;
    u.value = function(k, N) {
      return function w(B, K) {
        if (!B)
          return;
        const { fieldNames: A } = N, j = [];
        return B.forEach((H, U) => {
          const _ = Ta({ treeNodeData: H, treeProps: N, parentNode: K, isTail: U === B.length - 1 });
...
var Va = defineComponent({ name: "Tree", components: { VirtualList: Bs, TreeNode: _a }, props: { size: { type: String, default: "medium" }, blockNode: { type: Boolean }, defaultExpandAll: { type: Boolean, default: true }, multiple: { type: Boolean }, checkable: { type: [Boolean, String, Function], default: false }, selectable: { type: [Boolean, Function], default: true }, checkStrictly: { type: Boolean }, checkedStrategy: { type: String, default: "all" }, defaultSelectedKeys: { type: Array }, selectedKeys: { type: Array }, defaultCheckedKeys: { type: Array }, checkedKeys: { type: Array }, defaultExpandedKeys: { type: Array }, expandedKeys: { type: Array }, data: { type: Array, default: () => [] }, fieldNames: { type: Object }, showLine: { type: Boolean }, loadMore: { type: Function }, draggable: { type: Boolean }, allowDrop: { type: Function }, filterTreeNode: { type: Function }, searchValue: { type: String, default: "" }, virtualListProps: { type: Object }, defaultExpandSelected: { type: Boolean }, defaultExpandChecked: { type: Boolean }, autoExpandParent: { type: Boolean, default: true }, halfCheckedKeys: { type: Array }, onlyCheckLeaf: { type: Boolean, default: false }, animation: { type: Boolean, default: true }, actionOnNodeClick: { type: String }, disableSelectActionOnly: { type: Boolean, default: false } }, emits: { select: (e, t) => true, "update:selectedKeys": (e) => true, check: (e, t) => true, "update:checkedKeys": (e) => true, "update:halfCheckedKeys": (e) => true, expand: (e, t) => true, "update:expandedKeys": (e) => true, dragStart: (e, t) => true, dragEnd: (e, t) => true, dragOver: (e, t) => true, dragLeave: (e, t) => true, drop: (e) => true }, setup(e, { emit: t, slots: a }) {
  const { data: l, showLine: r, multiple: c, loadMore: n, checkStrictly: i, checkedKeys: o, defaultCheckedKeys: u, selectedKeys: p, defaultSelectedKeys: C, expandedKeys: b, defaultExpandedKeys: S, checkedStrategy: k, selectable: N, checkable: w, blockNode: B, fieldNames: K, size: A, defaultExpandAll: j, filterTreeNode: H, draggable: U, allowDrop: _, defaultExpandSelected: G, defaultExpandChecked: m2, autoExpandParent: P, halfCheckedKeys: de, onlyCheckLeaf: Se, animation: ke } = toRefs(e), ae = pe("tree"), E = computed(() => [`${ae}`, { [`${ae}-checkable`]: w.value, [`${ae}-show-line`]: r.value }, `${ae}-size-${A.value}`]), I = Sp(a, "switcher-icon"), s = Sp(a, "loading-icon"), h2 = Sp(a, "drag-icon"), z = Sp(a, "icon"), M = Sp(a, "title"), ye = Sp(a, "extra"), { treeData: Ne, flattenTreeData: be, key2TreeNode: T } = Ra(reactive({ treeData: l, selectable: N, showLine: r, blockNode: B, checkable: w, fieldNames: K, loadMore: n, draggable: U })), { checkedKeys: Z, indeterminateKeys: se, setCheckedState: J } = Fa(reactive({ defaultCheckedKeys: u, checkedKeys: o, checkStrictly: i, key2TreeNode: T, halfCheckedKeys: de, onlyCheckLeaf: Se })), [fe, Ce2] = F((C == null ? void 0 : C.value) || [], reactive({ value: p })), le = ref([]), ie = ref(), [Ke, Pe] = F(function() {
    ...
    return [];
  }(), reactive({ value: b })), he = ref([]), Ot = computed(() => {
    const d = new Set(Ke.value), v = new Set(he.value);
    return be.value.filter((y) => {
      var f;
      if (!(!H || !H.value || H != null && H.value(y.treeNodeData)))
        return false;
      const x = xl(y.parentKey), O = (f = y.pathParentKeys) == null ? void 0 : f.every((ce) => d.has(ce) && !v.has(ce));
      return x || O;
    });
  });
  function lt(d, v = k.value) {
    ...
    return v === "parent" ? y = d.filter((f) => {
      const x = T.value.get(f);
      return x && !(!xl(x.parentKey) && d.includes(x.parentKey));
  ...
  function ot(d, v, y) {
    if (he.value.includes(v) || !T.value.get(v))
      return;
    const f = new Set(Ke.value);
    d ? f.add(v) : f.delete(v);
    const x = [...f];
    Pe(x), ke.value && he.value.push(v), Ae({ targetKey: v, targetExpanded: d, newExpandedKeys: x, event: y });
  }
  function rt(d) {
    const v = he.value.indexOf(d);
    he.value.splice(v, 1);
  }
  const Pt = computed(() => n != null && n.value ? async (d) => {
    ...
    if (c.value) {
      ...
      f = true, y = [d];
    Ce2(y), je2({ targetKey: d, targetSelected: f, newSelectedKeys: y, event: v });
  }, onExpand: ot, onExpandEnd: rt, allowDrop(d, v) {
    const y = T.value.get(d);
    return !y || !Je(_.value) || !!_.value({ dropNode: y.treeNodeData, dropPosition: v });
  }, onDragStart(d, v) {
    const y = T.value.get(d);
  ...
  return provide(Tt, it), { classNames: E, visibleTreeNodeList: Ot, treeContext: it, virtualListRef: ref(), computedSelectedKeys: fe, computedExpandedKeys: Ke, computedCheckedKeys: Z, computedIndeterminateKeys: se, getPublicCheckedKeys: lt, getNodes: we, internalCheckNodes: function(d, v, y) {
    ...
    }), J(f, x), ze({ targetKey: y, targetChecked: xl(y) ? void 0 : v, newCheckedKeys: f, newIndeterminateKeys: x });
    ...
    if (c.value) {
      ...
      f = v ? [d[0]] : [];
    Ce2(f), je2({ targetKey: y, targetSelected: xl(y) ? void 0 : v, newSelectedKeys: f });
  }, internalSetSelectedKeys: function(d) {
    let v = d;
    !c.value && d.length > 1 && (v = [d[0]]), Ce2(v), je2({ newSelectedKeys: v });
    ...
    const x = [...f];
    Pe(x), Ae({ targetKey: y, targetExpanded: xl(y) ? void 0 : v, newExpandedKeys: x });
  }, internalSetExpandedKeys: function(d) {
    he.value = [], Pe(d), Ae({ newExpandedKeys: d });
  } };
  ...
  const { checkStrictly: l, treeContext: r } = this, { key2TreeNode: c } = r, n = pl(e), i = (n ? e : [e]).filter((o) => {
    const u = c.get(o);
    return u && xe(u) && (l || !a || function(p) {
      return On(p.isLeaf) ? p.isLeaf : !p.children;
    }(u));
  });
  ...
  const { key2TreeNode: a } = this.treeContext, l = pl(e), r = (l ? e : [e]).filter((c) => {
    const n = a.get(c);
    return n && ft(n);
  });
...
var Qa = defineComponent({ __name: "index", props: { data: { default: () => [] }, disabled: { type: Boolean, default: false }, loading: { type: Boolean, default: false }, searchForm: { default: () => ({}) }, size: { default: "small" }, tip: { default: "加载中..." }, searchTabs: { type: Boolean, default: false }, options: { default: () => ({ index: false }) } }, emits: ["update:searchForm"], setup(e, { emit: t }) {
  ...
  return (n, i) => {
    const o = mp, u = Fe, p = Lr, C = va, b = $t, S = Mr, k = Ee, N = Ma, w = ws, B = ba;
    return openBlock(), createBlock(B, { position: "left", size: n.size, style: { height: "100%" } }, { default: withCtx(() => [createVNode(k, { key: "1" }, { title: withCtx(() => [qa, createTextVNode(" 查询 ")]), default: withCtx(() => [createBaseVNode("div", Wa, [createBaseVNode("div", Ua, [createVNode(p, { model: l.value, size: n.size, layout: "vertical", disabled: n.disabled }, { default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(n.options.columns, (K, A) => (openBlock(), createElementBlock(Fragment, { key: A }, [K.search ? (openBlock(), createBlock(u, { key: 0, field: K.title, label: K.title }, { default: withCtx(() => [createVNode(o, { modelValue: l.value[K.dataIndex], "onUpdate:modelValue": (j) => l.value[K.dataIndex] = j, placeholder: `请输入 ${K.title}`, "allow-clear": "" }, null, 8, ["modelValue", "onUpdate:modelValue", "placeholder"])]), _: 2 }, 1032, ["field", "label"])) : createCommentVNode("", true)], 64))), 128))]), _: 1 }, 8, ["model", "size", "disabled"])]), createVNode(C, { margin: 10 }), createBaseVNode("div", Ya, [createVNode(S, null, { default: withCtx(() => [createVNode(b, { type: "primary", size: n.size, onClick: r }, { icon: withCtx(() => [Ga]), default: withCtx(() => [createTextVNode(" 查询 ")]), _: 1 }, 8, ["size"]), createVNode(b, { size: n.size, onClick: c }, { icon: withCtx(() => [Ja]), default: withCtx(() => [createTextVNode(" 重置 ")]), _: 1 }, 8, ["size"])]), _: 1 })])])]), _: 1 }), createVNode(k, { key: "2", title: "分类" }, { default: withCtx(() => {
      var K;
      return [n.options.columns && ((K = n.options.columns) == null ? void 0 : K.length) > 0 ? (openBlock(), createBlock(N, { key: 0, data: n.options.columns }, null, 8, ["data"])) : (openBlock(), createBlock(w, { key: 1 }))];
    }), _: 1 }), createVNode(k, { key: "3", title: "其他" }, { default: withCtx(() => [createTextVNode(" Content of Tab Panel 3")]), _: 1 })]), _: 1 }, 8, ["size"]);
  };
} });
var il = Ce(Qa, [["__scopeId", "data-v-6060aa38"]]);
export {
  il as default
};
//# sourceMappingURL=index-de7bee66-FBAFENEN.js.map
