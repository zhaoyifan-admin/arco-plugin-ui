/*
  ...
  return fetch('https://api.github.com/repos/themusecatcher/vue-arco-ui/contents/package.json?ref=master', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/themusecatcher/vue-arco-ui/master/package.json')
*/
