/*
  ...
  return fetch('https://api.github.com/repos/zhaoyifan-admin/vue-arco-ui/contents/package.json?ref=master', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/zhaoyifan-admin/vue-arco-ui/master/package.json')
*/
