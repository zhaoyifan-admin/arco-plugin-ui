<template>
  <div>
    ...
    <eh-Result title="Your operation has been executed">
      <template #extra>
        <eh-Button key="console" type="primary">Go Console</eh-Button>
      </template>
    </eh-Result>
    <h2 class="mt30 mb10">警告类型的结果</h2>
    <eh-Result status="warning" title="There are some problems with your operation.">
      <template #extra>
        <eh-Button key="console" type="primary">Go Console</eh-Button>
      </template>
    </eh-Result>
    ...
    >
      <template #extra>
        <eh-Button key="console" type="primary">Go Console</eh-Button>
        <eh-Button key="buy">Buy Again</eh-Button>
      </template>
    ...
    <eh-Result status="403" title="403" sub-title="Sorry, you are not authorized to access this page.">
      <template #extra>
        <eh-Button type="primary">Back Home</eh-Button>
      </template>
    </eh-Result>
    <h2 class="mt30 mb10">404 此页面未找到</h2>
    <eh-Result status="404" title="404" sub-title="Sorry, the page you visited does not exist.">
      <template #extra>
        <eh-Button type="primary">Back Home</eh-Button>
      </template>
    </eh-Result>
    <h2 class="mt30 mb10">500 服务器发生了错误</h2>
    <eh-Result status="500" title="500" sub-title="Sorry, the server is wrong.">
      <template #extra>
        <eh-Button type="primary">Back Home</eh-Button>
      </template>
    </eh-Result>
    <h2 class="mt30 mb10">自定义 image</h2>
    <eh-Result title="Great, we have done all the operations!">
      <template #image>
      ...
      <template #extra>
        <eh-Button type="primary">Next</eh-Button>
      </template>
    </eh-Result>
  </div>
</template>
