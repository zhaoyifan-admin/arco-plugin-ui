...
<template>
  <div class="ml60">
    ...
    <Popconfirm
      ...
      @ok="confirm"
      @cancel="cancel">
      <eh-Button type="danger">Delete</eh-Button>
    </Popconfirm>
    ...
    <Popconfirm
      ...
      :show-cancel="false">
      <eh-Button type="primary">Hidden Cancel Btn</eh-Button>
    </Popconfirm>
    <Message ref="message" />
  </div>
</template>
